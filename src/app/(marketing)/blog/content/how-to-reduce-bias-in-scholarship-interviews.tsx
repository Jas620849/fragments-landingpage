...
export default function HowToReduceBiasInScholarshipInterviews() {
  return (
    <div className="space-y-8">
      <h2 className="text-2xl font-bold text-secondary">Start with the decision you are trying to protect</h2>
      <p>
        Scholarship interviews decide who gets funded and who does not. When the process is
        unstructured, interviewers often reward comfort and familiarity more than the criteria
        the program said it values. Affinity bias, confirmation bias, halo/horns effects, and
        contrast effects are common—and they are hard to notice in the moment because they feel
        like “good judgment.”
      </p>
      <p>
        This guide focuses on what committees can change in practice: define competencies before
        interviews begin, ask the same core questions, score against a shared rubric, calibrate
        raters, and separate evidence from vibe. It is written for program staff and interviewers
        who need an operational checklist, not a theory survey. For related detail, see our
        guides on{" "}
        <Link href="/blog/structured-vs-unstructured-interviews/" className="text-highlight-dark underline">
      ...
      <h2 className="text-2xl font-bold text-secondary">How Structured Interviews Reduce Bias</h2>
      <p>
      ...
      <h2 className="text-2xl font-bold text-secondary">Benefits of Bias Reduction in Scholarship Selection</h2>
      <p>
...
<div>
          <h3 className="font-bold text-secondary">What are the most common types of bias in scholarship interviews?</h3>
          <p className="mt-2">
...
<div>
          <h3 className="font-bold text-secondary">How effective are structured interviews at reducing bias?</h3>
          <p className="mt-2">
...
<div>
          <h3 className="font-bold text-secondary">Can technology help reduce bias in scholarship interviews?</h3>
          <p className="mt-2">
...
<div>
          <h3 className="font-bold text-secondary">How can I train interviewers to recognize and overcome their biases?</h3>
          <p className="mt-2">
      ...
      <h2 className="text-2xl font-bold text-secondary">What to do next</h2>
      <p>
        Bias reduction is not a one-time workshop. Pick one concrete change for the next cycle:
        lock the question set, publish the rubric before interviews start, run a short
        calibration on sample answers, and compare scores across interviewers. Measure whether
        those steps reduce unexplained score gaps—not whether the process “feels fairer.”
      </p>
      <p>
        Continue with{" "}
        <Link href="/blog/common-interview-scoring-mistakes/" className="text-highlight-dark underline">
        ...
        . If you are exploring Fragments for classroom discussion, start with{" "}

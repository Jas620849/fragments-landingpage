...
export default function InterviewDataAnalytics() {
  return (
    <div className="space-y-8">
      ...
      <p>
        Data collection infrastructure must be in place before analytics can begin. Digital interview workflows described in our <Link href="/blog/" className="text-highlight-dark underline">guides</Link> automatically capture rich data that manual processes cannot. Investment in data collection infrastructure enables sophisticated analysis.
      </p>
      <p>

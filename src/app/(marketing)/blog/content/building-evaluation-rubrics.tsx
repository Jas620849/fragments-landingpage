...
export default function BuildingEvaluationRubrics() {
  return (
    <div className="space-y-8">
      <h2 className="text-2xl font-bold text-secondary">Build a rubric you can score in real time</h2>
      <p>
        A rubric that looks impressive in a PDF and collapses in a live interview is not a
        rubric—it is decoration. Start from the decision you must make (who advances, who is
        funded), name 4–6 competencies max, write anchors that cite observable behavior, then
        pilot the sheet on two sample answers before you touch real candidates.
      </p>
      <p>
        This is a how-to, not a theory overview. You will define goals, write dimensions,
        draft anchors, pilot, and revise. If you need interview-specific scoring habits after
        the sheet exists, continue to{" "}
        <Link href="/blog/common-interview-scoring-mistakes/" className="text-highlight-dark underline">
          scoring best practices
        </Link>
        . Teachers adapting the same habit for discussion trails can start with{" "}
        <Link href="/blog/educational-assessment-tools/" className="text-highlight-dark underline">
          assessing classroom discussion quality
        </Link>
        .
      </p>

      <h2 className="text-2xl font-bold text-secondary">Step 1: Define Evaluation Goals</h2>
      <p>
      ...
      <h2 className="text-2xl font-bold text-secondary">Step 2: Develop Criteria</h2>
      <p>
      ...
      <h2 className="text-2xl font-bold text-secondary">Step 3: Create Rating Scales</h2>
      <p>
      ...
      <h2 className="text-2xl font-bold text-secondary">Step 4: Write Performance Descriptors</h2>
      <p>
      ...
      <h2 className="text-2xl font-bold text-secondary">Step 5: Pilot and Refine</h2>
      <p>
...
<div>
          <h3 className="font-bold text-secondary">What are the key steps in building an evaluation rubric?</h3>
          <p className="mt-2">
...
<div>
          <h3 className="font-bold text-secondary">What rating scale works best for evaluation rubrics?</h3>
          <p className="mt-2">
...
<div>
          <h3 className="font-bold text-secondary">How can programs ensure criteria are observable and specific?</h3>
          <p className="mt-2">

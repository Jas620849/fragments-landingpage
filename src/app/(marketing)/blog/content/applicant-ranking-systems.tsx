...
export default function ApplicantRankingSystems() {
  return (
    <div className="space-y-8">
      ...
      <p>
        Technology platforms enable efficient ranking of large applicant pools. Digital systems can process hundreds of applications quickly, apply complex scoring algorithms, and generate rankings instantly. Approaches covered in our <Link href="/blog/" className="text-highlight-dark underline">guides</Link> provide ranking capabilities that would be impractical manually.
      </p>
      <p>
